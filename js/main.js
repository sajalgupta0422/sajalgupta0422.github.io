...
"use strict";
    ...
    // Keep the validator if you want required-field checking
    $('#contact_form').validator();

    // IMPORTANT: do NOT override submission with AJAX.
    // Formspree needs a normal POST to the form's action URL.
    $('#contact_form').on('submit', function (e) {

        // If validator blocks it, just exit and let the validator show errors.
        if (e.isDefaultPrevented()) {
        return;
        }

        // Otherwise allow normal form submission to Formspree.
        // (No e.preventDefault(), no AJAX, no return false.)
    });
